(function() {
  ...
  //check if object vs array
  //if array loop through, pass in value, key , collection
  //same for object
  ...
  _.filter = function(collection, test) {
    //use _.each to iterate over collection
    // pass in collection/test into each
    // if they pass, grab values that do, put into array, return array
  ...
  _.map = function(collection, iterator) {
    ...
    // call each, function is going to add the result into the resultArr
    var resultArr = [];
    _.each(collection, function (value) {
  ...
  _.reduce = function(collection, iterator, accumulator) {
    // if accumulator is undefined set equal to first number.
    // call iterator of each collection item.
    var mutateArr = collection;
  ...
  _.every = function(collection, iterator) {
    ...
    //if iterator undefined set to identity
    if (iterator === undefined) {
      iterator = _.identity;
    }
